...
public class contectwriting extends AppCompatActivity {
 private Button appy_now_btn ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contectwriting);
        appy_now_btn = (Button)findViewById(R.id.apply_content_writing);
